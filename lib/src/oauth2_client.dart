...
/// RFC 6749 OAuth 2.0 client.
///
/// Implements the following grant flows defined in
/// [RFC 6749](https://www.rfc-editor.org/rfc/rfc6749):
///
/// - **Authorization Code Grant** (§4.1): [composeAuthorizationCodeGrantUrl],
///   [parseAuthorizationCodeGrantRedirectionUri], [authorizationCodeTokenGrant]
/// - **Implicit Grant** (§4.2): [composeImplicitGrantUrl],
///   [parseImplicitGrantRedirectionUri]
/// - **Resource Owner Password Credentials Grant** (§4.3):
///   [resourceOwnerPasswordCredentialsGrant]
/// - **Client Credentials Grant** (§4.4): [clientCredentialsGrant]
/// - **Extension Grant** (§4.5): [extensionGrant]
/// - **Refresh Token** (§6): [refreshToken]
/// - **Token Revocation** (RFC 7009): [revokeToken]
///
/// All methods are static. Inject an [OAuth2HttpRequestHandler] for token
/// endpoint calls and supply an [OAuth2State] generated by [OAuth2State.random]
/// for flows that need CSRF protection.
class OAuth2Client {
